...
# local education agency. If it was not split into 32+ administrative units,
# it would total approximately 847,000 students and account for 33.44% of NY state's students.
ny_stats <- join %>%
